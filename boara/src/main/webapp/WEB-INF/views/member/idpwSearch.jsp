...
<body>
	...
	<div class="w3-modal" id="srchIdResult">
		<div class="w3-modal-content w3-animate-top w3-card-4">
		 	<header class="w3-text-white w3-indigo w3-padding w3-border-bottom w3-large">아이디 찾기</header>
	...
	<div class="w3-modal" id="srchPwResult">
		<div class="w3-modal-content w3-animate-top w3-card-4">
		 	<header class="w3-text-white w3-indigo w3-padding w3-border-bottom w3-large">비밀번호 찾기</header>
		 	<div class="w3-container">
